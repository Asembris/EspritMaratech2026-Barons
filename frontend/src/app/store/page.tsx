...
import { ShoppingCart, Plus, Search, Package, X, Loader2, Image as ImageIcon, ChevronLeft, ChevronRight, Camera } from 'lucide-react';
...
export default function StorePage() {
    ...
    const handleRemoveFromCart = async (productName: string) => {
        if (!user) return;
        try {
            await removeFromCart(user.id, productName);
            fetchOnlyCart();
