...
export function GestureDetector({ onGestureDetected }: Props) {
    ...
    }, [speak, onGestureDetected, startHoldTimer]);
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
                ...
                <div className="p-6 border-b lg:border-b-0 lg:border-r border-border">
                    <div className="relative aspect-video bg-muted rounded-xl overflow-hidden border-2 border-border mb-4">
                        ...
                        {isActive && (
                            <div className={`absolute top-4 right-4 px-3 py-1 rounded-full text-sm font-semibold ${handDetected
                    ...
                    <button
                        ...
                        disabled={loading}
                        aria-label={isActive ? 'Arrêter la caméra' : 'Démarrer la caméra'}
                        className={[
